...
export const NIGERIA_PROFILE: CountryPayrollProfile = {
  ...
  sourceNotes: 'Nigeria Tax Act (NTA) 2025, signed June 26 2025, effective January 1 2026. Replaces PITA. Verified against KPMG, EY, and PwC analyses.',
  ...
  statutoryDeductions: [
    ...
    },
    {
      ...
      preTax: false,
      mandatory: false,
      mandatoryConditions: 'Organizations with 5 or more employees or annual turnover above ₦50 million',
      notes: 'Many small farms are below the threshold.',
    },
  ],
  ...
  thresholds: [
    {
      ...
      annualAmount: 800000,
      description: 'Employees with annual chargeable income of ₦800,000 or less are exempt from PAYE.',
    },
  ],
}
